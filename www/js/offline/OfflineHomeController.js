angular.module('LaundryWaves')
  .controller('OfflineHomeCtrl', function ($scope, $rootScope, $state, StorageFactory, $ionicSlideBoxDelegate, CategoryService, $ionicPlatform, InitializeFactory, HelperFactory) {
